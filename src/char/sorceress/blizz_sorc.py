...
class BlizzSorc(Sorceress):
    ...
    def kill_eldritch(self) -> bool:
        ...
        self._ice_blast((-50, -50), spray=60)
        #self._cast_static()
        wait(0.75)
        #move down
        ...
        self._ice_blast((100, -300), spray=60)
        #self._cast_static()
        #move down
        wait(0.75)
        ...
        self._ice_blast((-50, -130), spray=60)
        #self._cast_static()
#         wait(3.0)
...
#         self._ice_blast((-50, -130), spray=60)
    ...
    def kill_shenk(self) -> bool:
        ...
        self._cast_static()
        self._blizzard((50, -50), spray=10)
        self._ice_blast((50, -100), spray=60)
        self._blizzard((0, -50), spray=10)
        self._ice_blast((50, -100), spray=60)
        self._blizzard((0, -50), spray=10)
